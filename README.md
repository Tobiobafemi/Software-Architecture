...
Controller Layer – Handles user interaction and request flow

Service Layer – Contains business logic for processing and comparing share prices

Data Provider Layer – Retrieves stock market data
